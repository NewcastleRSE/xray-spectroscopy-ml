...
"""Projected density of states (pDOS) descriptor for XANESNET."""
...
class PDOS(Descriptor):
    ...
    Args:
        ...
        method: xTB Hamiltonian.
        e_min: Lower energy bound for the pDOS grid. **eV**.
        e_max: Upper energy bound for the pDOS grid. **eV**.
        sigma: Gaussian broadening width (FWHM). **eV**.
        orb_type: AO type string for the primary DOS channel.
        quad_orb_type: AO type string for the quadrupole channel.
        num_points: Number of grid points.
        basis: Basis set for pySCF.
        init_guess: Initial-guess method for pySCF SCF.
        max_cycles: Maximum SCF iterations.
        use_charge: Read and apply the charge state from
            ``system.info``.
        use_spin: Read and apply the spin state from
            ``system.info``.
        use_quad: Also compute and append d-channel pDOS.
        use_occupied: Project onto occupied MOs instead of
            unoccupied.
        verbosity: Printout verbosity for xTB.
    """
