...
"""Automatic configuration resolver for the E3EE model."""
...
@ModelAutoResolver.register("e3ee")
def resolve_e3ee(inputs: dict[str, Any], target: torch.Tensor) -> ConfigRaw:
    ...
    Returns:
        Mapping with E3EE automatic field ``out_size``.
    """
